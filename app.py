...
def get_recommendations(df, item, month, rec_type, min_conf, min_lift, min_support, top_n, sort_by, bidirectional, sku_filter):
    if month != "Any":
...
top_rules = get_recommendations(
    ...
    top_n, sort_by, bidirectional, sku_filter
)
